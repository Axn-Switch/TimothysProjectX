<template>
    <div id="container">
        ...
        <section id="content-area">
            ...
            <div>
                <div v-for="broadcast in broadcasts" :key="broadcast.id" :style="{'background-image':`linear-gradient(to right,rgba(0, 0, 0, 0.7),rgba(0, 0, 0, 0.7)) ,url(${broadcast.Image})`}">
